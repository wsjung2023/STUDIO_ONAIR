...
- [x] R1-07 전체 검증
  ...
  - Windows 실제 4소스, 3,604 READY 세그먼트, 드롭 0, 보정 경계 0ms
  - 8개 concat asset 재조립, 단계별 핸들 상한, 취소/재시도·MP4 probe 통과
...
- [x] R2-01 커서 좌표·클릭 이벤트 소스 분리 기록
- [x] R2-02 클릭 강조·커서 숨김/교체
- [x] R2-03 자동 줌 후보·줌 구간 편집
- [x] R2-04 whisper.cpp 로컬 자막·단어/문장 타임스탬프
- [x] R2-05 transcript 비파괴 컷·침묵/필러 제안
- [x] R2-06 오디오 정리·음량 표준화
- [x] R2-07 전체 로컬 AI·승인/취소·실패 원자성 검증
...
R2-07 검증 증거(2026-07-20):

- 실제 30분 Windows 패키지에서 로컬 Whisper 제안 생성, 거절, 승인,
  저장·재열기, export 즉시 취소, 재시도 및 원자적 MP4 게시를 완료했다.
- 커서 소스 수명 주기 2,500회 반복과 실제 R2 워크플로에서 핸들 증가를
  제한 범위 안으로 확인했다.
- 상세 수치와 보존 산출물은
  `docs/verification/r2-07-full-product-verification.md`에 기록했다.
